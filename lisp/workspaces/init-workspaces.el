...
(defvar +workspaces-switch-project-function #'project-switch-project
...
(require 'doom-lib)
(require 'buffers-util)
(require 'workspaces-util)

(setq persp-autokill-buffer-on-remove 'kill-weak
      persp-reset-windows-on-nil-window-conf nil
      persp-nil-hidden t
      persp-auto-save-fname "autosave"
      persp-save-dir (concat user-emacs-directory  ".cache/workspace/")
